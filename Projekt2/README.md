...
📝 Wejście
Dwie liczby całkowite: szerokość W i wysokość H mapy.

Pozycja startowa: współrzędne kolumny i wiersza (0‐indeksowane).

Pozycja docelowa: współrzędne kolumny i wiersza (0‐indeksowane).

Liczba wyciągów N.

Dla każdego wyciągu kolejno:
...
Macierz wysokości terenu: H wierszy po W wartości.
